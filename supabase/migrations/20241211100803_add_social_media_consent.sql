...
begin
    begin
        ...
        insert into public.user_profiles (first_name, last_name, date_of_birth, phone_number, pronouns, gender,
                                          is_active, waitlist_id, medical_conditions, social_media_consent)
        values (first_name,
                last_name,
                date_of_birth,
                phone_number,
...
ALTER TYPE public.member_data_type ADD ATTRIBUTE social_media_consent public.social_media_consent;
