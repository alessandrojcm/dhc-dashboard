...
-- Update cron jobs to use extensions.net instead of net
-- Update process-emails cron job
SELECT cron.unschedule('process-emails-every-5-minutes');
...
-- Update process-workshop-announcements cron job
SELECT cron.unschedule('process-workshop-announcements');
SELECT cron.schedule(
...
-- Update process-discord-queue cron job
