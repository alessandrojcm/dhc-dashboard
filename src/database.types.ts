...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      check_refund_eligibility: { Args: { reg_id: string }; Returns: boolean }
      ...
      get_current_user_with_profile: { Args: never; Returns: Json }
      ...
      get_gender_options: { Args: never; Returns: Json }
      get_invitation_info: { Args: { p_invitation_id: string }; Returns: Json }
      get_member_data: {
      ...
      get_membership_info: { Args: { uid: string }; Returns: Json }
      get_waitlist_position: {
        Args: { p_waitlist_id: string }
        Returns: number
      }
      get_weapons_options: { Args: never; Returns: Json }
      has_any_role: {
        Args: {
      ...
      sync_all_stripe_customers: { Args: never; Returns: undefined }
