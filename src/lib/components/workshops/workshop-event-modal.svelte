...
const _interestCount = $derived.by(() => {
...
const _deletePopoverOpen = $state(false);
const _cancelPopoverOpen = $state(false);

// Check if actions are actually provided
const _hasEditAction = $derived(!!event.handleEdit);
</script>
							...
							<div class="space-y-3">
								<div class="space-y-2">
									...
									<p class="text-sm text-muted-foreground">
										Are you sure you want to cancel "{workshop.title}"? This action cannot be
										undone.
									</p>
								</div>
						...
						<Popover.Content class="w-80 bg-white">
							<div class="space-y-3">
								<div class="space-y-2">
									...
									<p class="text-sm text-muted-foreground">
										Are you sure you want to permanently delete "{workshop.title}"? This action
										cannot be undone.
									</p>
								</div>
								<div class="flex justify-end gap-2">
