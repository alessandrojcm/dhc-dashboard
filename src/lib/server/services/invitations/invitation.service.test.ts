...
import { InvitationCreateSchema, InvitationStatusUpdateSchema } from './invitation.service';
...
describe('InvitationService', () => {
	...
	describe('Service methods', () => {
		it('should have getInvitationInfo method', () => {
			...
			expect(typeof InvitationService.prototype.getInvitationInfo).toBe('function');
		});
