...
export type WaitlistEntryInsert =
	Database["public"]["Tables"]["waitlist"]["Insert"];
export type WaitlistEntryUpdate =
	Database["public"]["Tables"]["waitlist"]["Update"];
export type WaitlistStatus = Database["public"]["Enums"]["waitlist_status"];

// Guardian types from database
export type WaitlistGuardian =
	Database["public"]["Tables"]["waitlist_guardians"]["Row"];
export type WaitlistGuardianInsert =
	Database["public"]["Tables"]["waitlist_guardians"]["Insert"];
export type WaitlistGuardianUpdate =
	Database["public"]["Tables"]["waitlist_guardians"]["Update"];
