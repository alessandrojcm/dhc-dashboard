...
import type { Registration, RegistrationFilters, RegistrationWithUser } from './types';
...
export class RegistrationService {
	 ...
	 */
	async getWorkshopAttendees(workshopId: string): Promise<RegistrationWithUser[]> {
	 ...
	 */
	async _findById(trx: Transaction<KyselyDatabase>, id: string): Promise<Registration> {
