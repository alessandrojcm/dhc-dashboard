...
async function resetExpiredSubscriptions() {
	...
	await kysely.transaction().execute(async (trx) => {
		...
		console.log(`Created subscriptions for user ${customerId}`);
		...
		console.log(`Created payment intents for user ${customerId}`);
		console.debug(monthlyPayment, annualPayment);

		// Store the payment session using Kysely
		console.log(`Creating payment session for user ${customerId}`);
		console.log(
			monthlySubscription,
			annualSubscription,
			monthlyPayment,
