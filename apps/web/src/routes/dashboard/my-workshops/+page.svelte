			...
			{:else}
				<Card>
					<CardHeader>
						...
						<CardDescription
							>View upcoming workshops and sign up for them</CardDescription
						>
					</CardHeader>
					<CardContent>
						<WorkshopList
		...
		<TabsContent value="planned">
			...
			{:else if workshopsQuery.error}
				<Card>
					<CardContent class="pt-6">
						<p class="text-destructive">
							{workshopsQuery.error.errors?.detail ||
								"Failed to load workshops"}
						</p>
					</CardContent>
				</Card>
			{:else}
				<Card>
					<CardHeader>
						...
						<CardDescription
							>View planned workshops and express your interest</CardDescription
						>
					</CardHeader>
					<CardContent>
						<WorkshopList
