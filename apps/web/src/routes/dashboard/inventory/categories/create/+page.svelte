...
<div class="p-6">
	<div class="mb-6">
		...
		<p class="text-muted-foreground">
			Define a new equipment category with custom attributes
		</p>
	</div>
	...
	<form {...createCategory} class="space-y-6">
		...
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Define the attributes that items in this category will have. For
					example, masks might have attributes like "brand", "size", and
					"color".
				</CardDescription>
			</CardHeader>
			<CardContent>
