...
<div class="p-6">
	...
	<form {...updateCategory} class="space-y-6">
		...
		<Card>
			<CardHeader>
				...
				<CardDescription
					>Basic details about the equipment category</CardDescription
				>
			</CardHeader>
		...
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Define the attributes that items in this category will have. Be
					careful when removing attributes as it may affect existing items.
				</CardDescription>
			</CardHeader>
			<CardContent>
				<AttributeBuilder
	...
	<Card class="mt-6 border-destructive">
		<CardHeader>
			...
			<CardDescription>
				Permanently delete this category. This action cannot be undone and will
				affect all items in this category.
			</CardDescription>
		</CardHeader>
		<CardContent>
			...
			{:else}
				<div class="space-y-4">
					<p class="text-sm text-muted-foreground">
						...
						all items in this category. This action cannot be undone.
					</p>
					<div class="flex gap-3">
						<form {...deleteCategory}>
							<Button
