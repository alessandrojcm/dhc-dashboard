	...
	<div class="flex items-center justify-between mb-6">
		<div>
			...
			<p class="text-muted-foreground">
				Manage storage locations and hierarchy
			</p>
		</div>
		{#if data.canEdit}
	...
	{:else if containersQuery.isError}
		<Card>
			<CardContent class="flex flex-col items-center justify-center py-12">
				...
				<Button onclick={() => containersQuery.refetch()} variant="outline"
					>Retry</Button
				>
			</CardContent>
		</Card>
							...
							>
									...
									<div class="flex items-center gap-2">
										...
										{#if hasChildren}
											<Badge variant="secondary" class="text-xs">
												{container.children.length} child{container.children
													.length !== 1
													? "ren"
													: ""}
											</Badge>
								...
								<div class="flex items-center gap-2">
									<Badge variant="outline" class="flex items-center gap-1">
										...
										{container.itemCount} item{container.itemCount !== 1
											? "s"
											: ""}
									</Badge>
