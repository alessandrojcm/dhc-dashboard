...
<div class="p-6">
	<div class="mb-6">
		...
		<p class="text-muted-foreground">
			Add a new storage container to organize your inventory
		</p>
	</div>
	...
	<div class="max-w-2xl">
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Provide information about the new container. You can organize
					containers hierarchically by selecting a parent container.
				</CardDescription>
			</CardHeader>
			<CardContent>
				<form {...createContainer} class="space-y-6">
					...
					<Field.Field>
						...
						<Select
							...
							onValueChange={(v) =>
								createContainer.fields.parent_container_id.set(v)}
