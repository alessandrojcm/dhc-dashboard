...
{:then planPricing}
	{#if planPricing.complimentary}
		<Card.Root class="border-green-200 bg-green-50">
			<Card.Content class="py-5">
				<div class="flex items-start justify-between gap-4">
					<div>
						<p class="font-semibold text-green-800">Coach membership</p>
						<p class="mt-1 text-sm leading-6 text-green-700">
							Your membership is complimentary. There are no membership fees now
							or in the future.
						</p>
					</div>
					<span class="text-lg font-bold text-green-800">€0.00</span>
				</div>
			</Card.Content>
		</Card.Root>
	{:else}
