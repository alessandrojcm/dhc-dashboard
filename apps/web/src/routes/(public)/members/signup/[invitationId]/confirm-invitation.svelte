...
{#if isVerified}
	<div class="space-y-6">
		<Alert.Root variant="success" class="w-full mb-6">
			...
			<Alert.Description>
				Your invitation has been successfully verified. Please complete your
				membership signup below.
			</Alert.Description>
		</Alert.Root>
	</div>
{:else}
	<div class="max-w-md mx-auto p-6">
		...
		{#if validateInvitation.result?.success === false}
			<Alert.Root variant="destructive" class="w-full mb-6">
				...
				<Alert.Description
					>Something has gone wrong with your invitation or your data is not
					correct, if this persist please contact us.
				</Alert.Description>
			</Alert.Root>
		{/if}
