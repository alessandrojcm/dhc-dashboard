...
<div class="workshop-calendar-container relative">
	...
	<!-- Legend -->
	<div
		class="flex flex-wrap items-center gap-x-6 gap-y-2 mt-4 text-sm text-muted-foreground"
	>
		...
		<div class="flex items-center gap-2">
			<div
				class="w-4 h-4 bg-green-500 rounded-sm border border-green-500/20"
			></div>
			<span>Published</span>
		</div>
		<div class="flex items-center gap-2">
			<div
				class="w-4 h-4 bg-destructive rounded-sm border border-destructive/20"
			></div>
			<span>Cancelled</span>
		</div>
		<div class="flex items-center gap-2">
