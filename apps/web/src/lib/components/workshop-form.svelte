	...
	>
		...
		<div class="space-y-6">
			...
			<div class="grid grid-cols-1 gap-6 md:grid-cols-2">
				<Field.Field>
					...
					<Field.Label for={fieldProps.name}>Maximum Capacity</Field.Label>
					<Input
						{...fieldProps}
						id={fieldProps.name}
						min="1"
				...
				<Field.Field>
					...
					<Field.Label for={fieldProps.name}>Refund Deadline (days)</Field.Label
					>
					<Input
						{...fieldProps}
						id={fieldProps.name}
			...
			<div class="space-y-6">
				...
				<div class="rounded-lg border border-blue-200 bg-blue-50 p-4">
					<p class="mb-4 text-sm text-blue-700">
						All workshop status changes will be announced through selected
						channels
					</p>
					...
					<div class="space-y-4">
						<div class="flex items-center space-x-3">
							<Switch
								id="announce_discord"
								checked={Boolean(
									createWorkshop.fields.announce_discord.value(),
								)}
								onCheckedChange={(v) =>
							...
							<input
								...
								value={String(
									Boolean(createWorkshop.fields.announce_discord.value()),
								)}
							/>
							<div>
						...
						<div class="flex items-center space-x-3">
							...
							<input
								...
								name="announce_email"
								value={String(
									Boolean(createWorkshop.fields.announce_email.value()),
								)}
							/>
							<div>
		...
		<div class="space-y-6">
			...
			<div class="grid grid-cols-1 gap-6 md:grid-cols-2">
				...
				{#if isPublic}
					{@const fieldProps = remoteForm.fields.price_non_member.as("number")}
					<Field.Field>
