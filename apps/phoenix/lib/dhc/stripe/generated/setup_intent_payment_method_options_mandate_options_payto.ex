defmodule Dhc.Stripe.SetupIntentPaymentMethodOptionsMandateOptionsPayto do
  @moduledoc """
  Provides struct and type for a SetupIntentPaymentMethodOptionsMandateOptionsPayto
  """
