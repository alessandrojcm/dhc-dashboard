defmodule Dhc.Stripe.CheckoutCustomerBalanceBankTransferPaymentMethodOptions do
  @moduledoc """
  Provides struct and type for a CheckoutCustomerBalanceBankTransferPaymentMethodOptions
  """
