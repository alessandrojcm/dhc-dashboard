defmodule Dhc.Stripe.PaymentMethodDetailsCardPresentReceipt do
  @moduledoc """
  Provides struct and type for a PaymentMethodDetailsCardPresentReceipt
  """
  ...
  def __fields__(:t) do
    [
      account_type: {:enum, ["checking", "credit", "prepaid", "unknown"]},
