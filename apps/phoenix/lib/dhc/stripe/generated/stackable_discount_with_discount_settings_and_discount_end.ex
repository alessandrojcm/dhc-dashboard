defmodule Dhc.Stripe.StackableDiscountWithDiscountSettingsAndDiscountEnd do
  @moduledoc """
  Provides struct and type for a StackableDiscountWithDiscountSettingsAndDiscountEnd
  """
