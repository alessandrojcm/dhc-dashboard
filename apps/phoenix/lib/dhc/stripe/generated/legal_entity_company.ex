defmodule Dhc.Stripe.LegalEntityCompany do
  ...
  @type t :: %__MODULE__{
          ...
          administrative_address: Dhc.Stripe.Address.t() | nil,
          ...
          phone: String.t() | nil,
          principal_place_of_business: Dhc.Stripe.Address.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      administrative_address: {Dhc.Stripe.Address, :t},
      ...
      phone: :string,
      principal_place_of_business: {Dhc.Stripe.Address, :t},
