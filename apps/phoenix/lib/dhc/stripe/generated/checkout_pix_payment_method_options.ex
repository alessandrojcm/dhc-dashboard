defmodule Dhc.Stripe.CheckoutPixPaymentMethodOptions do
  @moduledoc """
  Provides struct and type for a CheckoutPixPaymentMethodOptions
  """
  ...
  defstruct [:amount_includes_iof, :expires_after_seconds, :mandate_options, :setup_future_usage]
