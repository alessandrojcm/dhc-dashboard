defmodule Dhc.Stripe.PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptions do
  @moduledoc """
  Provides struct and type for a PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptions
  """
