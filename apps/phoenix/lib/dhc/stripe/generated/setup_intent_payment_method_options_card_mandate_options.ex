defmodule Dhc.Stripe.SetupIntentPaymentMethodOptionsCardMandateOptions do
  @moduledoc """
  Provides struct and type for a SetupIntentPaymentMethodOptionsCardMandateOptions
  """
