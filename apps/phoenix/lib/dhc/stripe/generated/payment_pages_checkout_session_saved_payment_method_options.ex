defmodule Dhc.Stripe.PaymentPagesCheckoutSessionSavedPaymentMethodOptions do
  @moduledoc """
  Provides struct and type for a PaymentPagesCheckoutSessionSavedPaymentMethodOptions
  """
