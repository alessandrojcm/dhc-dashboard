defmodule Dhc.Stripe.SubscriptionsResourcePaymentMethodOptions do
  @moduledoc """
  Provides struct and type for a SubscriptionsResourcePaymentMethodOptions
  """
  ...
  @type t :: %__MODULE__{
          ...
          card: Dhc.Stripe.SubscriptionPaymentMethodOptionsCard.t() | nil,
          ...
          pix: Dhc.Stripe.SubscriptionPaymentMethodOptionsPix.t() | nil,
          sepa_debit: map | nil,
  ...
  def __fields__(:t) do
    [
      ...
      card: {Dhc.Stripe.SubscriptionPaymentMethodOptionsCard, :t},
      ...
      pix: {Dhc.Stripe.SubscriptionPaymentMethodOptionsPix, :t},
      sepa_debit: :map,
