defmodule Dhc.Stripe.SubscriptionPaymentMethodOptionsMandateOptionsParam do
  @moduledoc """
  Provides struct and types for a SubscriptionPaymentMethodOptionsMandateOptionsParam
  """
