...
| **Invitation Acceptance** | The atomic Onboarding conversion event where a prospective member accepts an invitation and is created or linked as a Member. It includes invitation validation, credential/profile handling, invite status changes, waitlist state changes when applicable, and related membership/payment linkage. |
