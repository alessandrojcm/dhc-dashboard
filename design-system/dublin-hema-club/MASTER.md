...
**Project:** Dublin HEMA Club
**Generated:** 2026-08-16 21:31:07
**Category:** Club operations dashboard
...
|------|-----|--------------|
| Primary | `#1F4F85` | `--color-primary` |
| On Primary | `#FFFFFF` | `--color-on-primary` |
| Secondary | `#E5B524` | `--color-secondary` |
| Accent/CTA | `#8D2140` | `--color-accent` |
| Background | `#F8F5EE` | `--color-background` |
| Foreground | `#121827` | `--color-foreground` |
| Muted | `#EAE5D9` | `--color-muted` |
| Border | `#BEC4CF` | `--color-border` |
| Destructive | `#87203C` | `--color-destructive` |
| Ring | `#E5B524` | `--color-ring` |

**Color Notes:** Brand-led heritage navy and gold, warmed with parchment surfaces and a restrained crimson accent.
...
.card {
  ...
  border-radius: 16px;
  padding: 24px;
  box-shadow: 4px 4px 0 rgb(18 24 39 / 12%);
  transition: all 200ms ease;
  cursor: pointer;
}
...
.input:focus {
  border-color: #1F4F85;
  outline: none;
  box-shadow: 0 0 0 3px rgb(229 181 36 / 30%);
}
```
